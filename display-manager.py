...
client = mqtt.Client()
"""
onConnect creates a connection between MQTT_BROKER and the client application
"""
...
"""
onMessage is a callback function that reads messages once the subscribed topic publishes a new message
"""
